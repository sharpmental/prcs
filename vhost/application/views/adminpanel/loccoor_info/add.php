...
<form class="form-horizontal" role="form" id="validateform"
	...
	<div class='panel panel-default'>
		...
		<div class='panel-body'>
			<fieldset>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="coor_id" id="coor_id" value=''
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="ori_x" id="ori_x" value=''
							class="form-control"  placeholder="请输入">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="ori_y" id="ori_y" value=''
							class="form-control"  placeholder="请输入">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="ori_z" id="ori_z" value=''
							class="form-control"  placeholder="请输入">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="angle_h" id="angle_h" value=''
							class="form-control"  placeholder="请输入">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="angle_v" id="angle_v" value=''
							class="form-control"  placeholder="请输入">
					</div>
				</div>
			</fieldset>
		...
		<?php aci_ui_button($folder_name,'loccoor_info','add','type="submit" id="dosubmit" class="btn btn-primary "','保存')?>
	</div>
		</div>
	</div>
</form>
