...
<div class="panel panel-default grid">
	...
	<div class="panel-body">
		...
		<h2><span class="glyphicon glyphicon-remove-sign"></span>No data table found. Check the database or your setup!</h2>
		<?php } else {?>
			<div class="row placeholders">
            <?php foreach ($table_data as $k => $v){ ?>
                <div class="col-xs-12 col-sm-3 ">
                    <a href=<?php echo base_url().'adminpanel/edittable/viewtable/'.$v['id']?>><p class="circle"><i class="fa fa-database fa-4x"></i></p>
                    <h5><?php echo $v['table_name'] ?></h5>
                    <h5><?php echo $v['comments'] ?></h5>
                    </a>
                    </br>
                </div>
            <?php } ?>
