                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navb	ar-right navbar-icon-menu">
                    	<?php if ($menu_data) foreach ($menu_data as $k => $v): ?>
                            <li><a href="<?php echo $v['url'] ?>"> <i class="fa fa-<?php echo $v['css_icon'] ?>"></i><span><?php echo $v['menu_name'] ?></span></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="col-sm-3 col-md-2 sidebar">
                    ...
                    <?php endforeach; ?>
                     ...
                     <?php if ($notification) foreach ($notification as $k => $v): ?>
                        <div class="list-group">
                            <li class="list-group-item active"><?php echo $v['title'] ?> </li>
                            <?php
                            $sub_array = $v['submenu'];
                            if ($sub_array){
                            	$i=0;
                                foreach ($sub_array as $key => $m) {
                                	...
                                	<span class="badge"><?php echo $m; ?></span></a>
                                	<?php 
                                	}
                                	$i = $i+1;
                                }
