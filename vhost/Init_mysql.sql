...
insert into `tb_table_edit_list` values
	(1,  'tb_people_info', 0, '#', '增加', '#', '修改', '#', '删除', '人员和对应腕表'),
	(2, 'tb_people_detail', 0, '#', '增加', '#', '修改', '#', '删除', '人员详细信息’'),
	(3, 'tb_watch_info', 0, '#', '增加', '#', '修改', '#',  '删除', '腕表启用信息'),
	(4, 'tb_alarm_general', 0,  '#', '增加', '#', '修改', '#',  '删除', '腕表基础状态'),
	(5, 'tb_alarm_loc', 0, '#', '增加', '#', '无', 'alarm_loc/clear', '清除报警',  '腕表定位信息表'),
	(6, 'tb_alarm_prohibit', 0, '#', '增加', '#', '无', '#', '清除报警',  '腕表警戒信息表'),
	(7, 'tb_alarm_enter', 0, '#', '增加', '#', '无', '#', '清除报警',  '腕表进入信息表'),
	(8, 'tb_alarm_mon', 0, '#', '增加', '#', '无', '#',  '清除报警', '腕表监控信息表'),
	(9, 'tb_department_info', 0, '#', '增加', '#', '修改', '#',  '删除', '部门信息表'),
	(10, 'tb_locarea_info', 0, '#', '增加', '#', '修改', '#',  '删除', '定位区域信息表'),
	...
	(18, 'tb_monarea_info', 0, '#', '增加', '#', '修改', '#',  '删除', '监控区域信息'),
